...
export default function ItemStats({ item }) {
  ...
  return (
    <>
      ...
      {item.attackMagicValue && <p className="text-green-400">{item.attackMagicValue}</p>}
      ...
      <p className="text-green-400">{t(item.bonus_3.name)} {item.bonus_3.value}</p>
      <p className="text-green-400">{t(item.bonus_4.name)} {item.bonus_4.value}</p>
      <p className="text-green-400">{t(item.bonus_5.name)} {item.bonus_5.value}</p>
      <p>{t('[Wearable]')}</p>
